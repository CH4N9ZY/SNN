...
from ILIFModel import mem_update
...
cfg_cnn = [(2, 32, 1, 0, 3), (32, 32, 1, 1, 3),]
...
class SCNN(nn.Module):
    ...
    def forward(self, input):
        ...
        images_truple = torch.split(input, 1, len(input.shape) - 1)
        ...
        outputs = h2_sumspike / len(images_truple)  #300
        return outputs
